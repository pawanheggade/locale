...
export const validatePostData = (
    ...
    const {
        title, description, location, hasCoordinates, price, isContactForPrice, isOnSale, salePrice,
    ...
    if (!isContactForPrice) {
        ...
        // Sale Price Validation (only if price is present and not contact-for-price)
