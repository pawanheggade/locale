    ...
    return (
        <div className="relative aspect-square bg-gray-100 rounded-xl overflow-hidden border group">
            ...
            <Button
                ...
                variant="overlay"
                size="xs"
                className="absolute top-1 right-1 w-6 h-6 p-0 flex items-center justify-center rounded-xl transition-all z-10 text-white"
                    ...
                    {mediaUploads.map((upload, index) => (
                        <div
                            ...
                            className={cn(
                                ...
                                dragOverIndex === index && draggedIndex !== index ? 'scale-105 ring-2 ring-red-500 ring-offset-2 z-10' : ''
                            )}
