...
export const App: React.FC = () => {
  ...
  const postActions: PostActions = useMemo(() => ({
    ...
    onToggleLikeAccount: (id) => { if(!currentAccount) openModal({type:'login'}); else toggleLikeAccount(id); },
  ...
  const renderCurrentView = () => {
    switch (view) {
        ...
        case 'forumPostDetail': return viewingForumPostId ? <ForumPostDetailView postId={viewingForumPostId} onBack={handleBack} /> : null;
        case 'createPost':
